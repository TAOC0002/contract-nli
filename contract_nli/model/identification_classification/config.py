...
def update_config(config, *, impossible_strategy, class_loss_weight, pre_seq_len, template):
    class IdentificationClassificationConfig(type(config)):
        ...
        def from_config(cls, config, *, impossible_strategy,
                        class_loss_weight, pre_seq_len, template):
    ...
    return IdentificationClassificationConfig.from_config(
        ...
        class_loss_weight=class_loss_weight, pre_seq_len=pre_seq_len, template=template)
